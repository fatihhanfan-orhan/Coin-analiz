...
function enrichRecoveryPlan(p,k15,k1h,k4h,k1d,m,h,flow,spread){
  ...
  p.recovery={drops,higherLow,base,reclaim,fourHourHold,fourHourFalling,newLow,sellingPressure,confirmedSupportBreak,confirmations,state,nearTarget:p.interimTarget,mainTarget:p.mainTarget,maxRecoveryLevel:priorPeak,maxRecoveryPct,guaranteed:false};return p;
}
